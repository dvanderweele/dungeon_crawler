...
1. Given a capped number of tries, keep trying to carve rooms out of a a grid of cells.
...
In the end, I realized that it wad an enormous effoet to go through to avoid learning how to do a basic webpack config. So I read through the docs — which are actually **amazing** — and it left me wondering why anyone ever complains about it. 
